...
return [
	 ...
	 * The recommended size is 32. Reduce this to reduce memory usage. Larger sample sizes make only tiny visual differences to the output image.
	 *
	 */
	"sampleMaxImageSize" => 32,
